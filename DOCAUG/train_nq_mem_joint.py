...
python -u train_nq_mem_joint.py \
  ...
  --raw_subset_file data/nq_subset/raw/nq_subset_100.jsonl \
  --aug_file /home/syt/project/Cram/DOCAUG/data/nq_subset/augmented/nq_multiqa_only_no_unans_first100.jsonl \
  --device cuda \
  --max_new_tokens 16 \
  --temperature 0.0 \
  --mem_len 1 \
  ...
  --ctx_window keyword \
  --enable_gc \
  --csv_out runs/nq_joint_results_200steps_100.csv \
  --save_preds runs/nq_joint_preds_200steps_100.jsonl \
  --verbose \
  --limit 10
